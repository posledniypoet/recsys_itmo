...
class StickyArtist(Recommender):
    ...
    def get_artist_data_sticky_artist(self, prev_track):
        ...
        return artist_data, artist_tracks

    def recommend_next(self, user: int, prev_track: int, prev_track_time: float) -> int:
        artist_data, artist_tracks = self.get_artist_data_sticky_artist(prev_track)
