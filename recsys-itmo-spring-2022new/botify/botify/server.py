...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            recommender = MyRecommender(tracks_redis, artists_redis, recommendations_redis, catalog, None, None, None)
        elif treatment == Treatment.T2:
            recommender = Contextual(tracks_redis.connection, catalog, random)
        elif treatment == Treatment.T3:
            recommender = Indexed(recommendations_redis.connection, catalog, random)
